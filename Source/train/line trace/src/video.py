...
def main():
    ...
    parser.add_argument('--image_folder', type=str, default='/home/aiteam/self-driving-vehicles-sim-with-ml/dataset/IMG/', help='Path to image folder. The video will be created from these images.')
    parser.add_argument('--fps',          type=int, default=15, help='FPS (Frames per second) setting for the video.')
    ...
    video_file_1 = '/home/aiteam/self-driving-vehicles-sim-with-ml/dataset/test.mp4'

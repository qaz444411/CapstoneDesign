...
class TripletDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        left_img, steering_angle_left     = augment(self.dataroot, batch_samples[1], steering_angle)
        right_img, steering_angle_right   = augment(self.dataroot, batch_samples[2], steering_angle)
